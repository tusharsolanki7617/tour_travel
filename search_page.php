...
<!-- <section class="search-form">
   <form action="" method="post">
      <input type="text" name="search_box" placeholder="Type to search..." maxlength="100" class="box" required>
...
<section class="search-form">
   <form action="" method="post" onsubmit="return validateSearch()">
      <input type="text" id="search_box" name="search_box" placeholder="Type to search..." maxlength="100" class="box">

      <button type="submit" class="fas fa-search" name="search_btn"></button>

   </form>
       <small id="searchError" class="error" ></small>
</section>
...
<script>
   function validateSearch() {
      let searchBox = document.getElementById("search_box").value.trim();
      let isValid = true;
